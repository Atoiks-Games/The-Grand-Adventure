...
namespace TheGrandAdventure
{
    class Chapter1
    {
        ...
        public void Part1()
        {
            ...
            WriteLine("Your party assembles down in the tavern. They speak amoung themselves, trying to decide which party member should go out to get the parcel.");
            WriteLine("Who should go? (Write the character's first name.");
        }
    }
}
